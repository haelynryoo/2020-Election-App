...
class CandidateInfoViewController: UIViewController {
    ...
    lazy var candidates: [candidate] = [
        ...
        candidate(Name: "Bernie Sanders",
                  ...
                  pastExperiences: "Bernie Sanders was elected the mayor of Burlington in 1981, and then to the House of Representatives in 1991. He ran for the democratic nominee inthe 2016 presidential election, and is currently one of the Senate representatives for Vermont. He was elected in 2007.",
                  Policies: "Bernie Sanders' campaign is very economically driven. He is supportive of the Green New Deal. He is also calling for Medicare for all and a $15 minimum wage. Bernie supports a reformation of Wall Street and making college tuition free. He is or criminal justice reform and is a firm believer in a solid establishment of the rights of women, people of color, immigrants and people in the LGBTQ community. He would aslo like to enforce the rights that have already been put in place.",
